...
|-------|-------|
| **Nome** | Rodger Koller |
| **Marca** | Fly to Fluency ® (marca registrada) |
...
| Seguindo | 3.983 |
| Categoria | Educação |
| Destaques | "I am handso...", DEPOIMENTOS, MEU CURSO, Recomendações |
| Posts fixados | "I'll Teach You English (Basic to Advanced)", Testimonial 1, Testimonial 2 |
| Estilo | Avatar cartoon (caveira na camiseta) + vídeos pessoais |
...
| Criado em | 14/Nov/2015 |
| País | Brasil |
| Descrição | "Intercâmbio na Irlanda" |
| Tabs | Home, Videos, Shorts, **Courses**, Playlists, Posts |

### Playlists YouTube
| Playlist | Videos |
|----------|--------|
| SPEEDRUN | 1 |
| LEARN VOCABULARY LIKE A NATIVE SPEAKER OF ENGLISH | 5 |
| REALIDADES DE DUBLIN | 22 |
| SHORTS | 2 |
| DUBLIN | 28 |
| VOCABULÁRIO | 10 |
...
| Titulo | Views |
|--------|-------|
| BRAZILIAN BANANA CAKE | 265 |
| PAÇOCA REACTION / COREIA DO NORTE, CHINA... | 595 |
| sham irish month | 334 |
| Every Breath You Take | 209 |
| QUAL A RECEITA DO SUCESSO? | 636 |
| Me siga no Instagram para mais | 395 |
...
| Status | **CONTA BLOQUEADA** — "Account has been blocked" |
| Impacto | TODOS os links de lead magnet nos vídeos do YouTube estão MORTOS |
| Link quebrado | rodgerkoller2018.systeme.io/21cb5077 (PDF gratuito) |
...
### Formato de vídeo
- **Storytelling pessoal** como gancho (ex: "My Worst Breakup") + ensino de vocabulário
- Trilíngue: conteúdo em inglês com descrição em PT-BR e espanhol
- Usa **dublagem automática** do YouTube pra outros idiomas
- Avatar cartoon como identidade visual (personagem com caveira)
- Nível declarado: B1/B2/C1 (intermediário a avançado)
- Legendas em PT-BR + EN nos vídeos

### Tom de voz
- Informal, humorístico, autoirônico ("Sexy Koller", "Muscular Tiger")
- Mistura PT e EN naturalmente
- Fala diretamente com a audiência, pede interação
- Transparente sobre números e dificuldades do canal

### Lead magnet
- PDF gratuito por aula (vocabulário + expressões)
- Distribuído via link na descrição do YouTube → Systeme.io
- **Atualmente quebrado** (conta bloqueada)
...
## OPORTUNIDADES MazyOS

### O que o MazyOS resolve imediatamente

| Necessidade | Skill | Ação |
|------------|-------|------|
| Reconstruir funil (Systeme morto) | `/seo` + Playwright | Landing page própria + formulário funcional |
| SEO do zero | `/seo` (8 etapas) | Keywords, on-page, Schema, GMB, GEO |
| Conteúdo recorrente | `/publicar-tema` + `/carrossel` | Blog + Instagram + YouTube de forma integrada |
| Google Ads | `/anuncio-google` | Campanhas pra "curso de inglês online" |
| Identidade visual consolidada | `identidade/design-guide.md` | 1 marca, 1 paleta, 1 tipografia |
| Reputação online | `/responder-avaliacoes` | Ativar Google Meu Negócio e gerenciar |
| Remarketing | `/email-sequencia` + `/whatsapp-fluxo` | Brevo + WhatsApp Business (blueprint já existe) |
| Monitoramento | `/relatorio-ads` + Playwright | Semanal de Ads + auditoria mensal do site |

### Diferenciais do Rodger que o MazyOS amplifica

1. **Cambridge CPE + CELTA** — credencial que 99% dos concorrentes não têm. O `/seo` + GEO pode posicionar isso no Google e nas IAs
2. **34.000 alunos** — prova social massiva que não está sendo usada. O `/carrossel` transforma isso em conteúdo
3. **412 vídeos no YouTube** — acervo enorme que pode ser reciclado em blog posts, carrosseis e shorts com `/publicar-tema`
4. **Trilíngue (PT/EN/ES)** — mercado hispânico é gigante e inexplorado. 3x o alcance potencial
5. **Storytelling como método** — diferencial de formato que o `/carrossel` pode replicar visualmente
6. **Humor e autenticidade** — tom de voz único que o `_memoria/preferencias.md` preserva em todas as entregas
