...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      "Perfil do Google arrumado e bem posicionado",
      "4 posts por mês no Instagram",
      "Suporte por email",
    ],
    cta: "Começar",
  },
  {
    ...
    features: [
      ...
      "12 posts por mês, você só aprova",
      "Painel do seu negócio (primeiro módulo sob medida)",
      "Suporte prioritário",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Painel completo construído pro que seu negócio precisar",
      "Respostas automáticas no direct do Instagram",
      "Relatórios semanais",
